    ...
    manual: [{
        ...
        },
        {
            ...
            items: [
                ...
                "user-documentation/z2_concept/datamodel-overview",
        ...
        },
        {
            ...
            items: [{
                type: 'autogenerated',
                dirName: 'user-documentation/10-notifications',
            }, ],
        }
    ],
    dev: [
        ...
        },
        {
            ...
            items: [
                ...
                },
                {
                    "Access instance": [{
                        type: 'autogenerated',
                        dirName: 'development/services/access-instance'
                    }]
                },
                {
                    "Access project": [{
                ...
                },
                {
                    "Admin instance": [{
                        type: 'autogenerated',
                        dirName: 'development/services/admin-instance'
                    }]
                },
                {
                    "Admin": [{
                        type: 'autogenerated',
                        dirName: 'development/services/admin'
                    }]
                },
                {
                    "Authentication": [{
                ...
                },
                {
                    "Data provider": [{
                        type: 'autogenerated',
                        dirName: 'development/services/dataprovider'
                    }]
                },
                {
                    "Delivery": [{
                ...
                },
                {
                    "Downloader": [{
                        type: 'autogenerated',
                        dirName: 'development/services/downloader'
                    }]
                },
                {
                    "Ingest": [{
                ...
                },
                {
                    "Neo Storage": [{
                        type: 'autogenerated',
                        dirName: 'development/services/neo-storage',
                    }],
                },
                {
                    "Worker Manager": [{
