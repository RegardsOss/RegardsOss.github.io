...
| Ansible property                                                     | REGARDS property                      |
| :------------------------------------------------------------------- | :------------------------------------ |
| group_docker_mservices.dam.configuration.crawler_rate_delay_ms       | regards.ingester.rate.ms              |
| group_docker_mservices.dam.configuration.database_max_pool_size      | regards.jpa.multitenant.maxPoolSize`  |
| group_docker_mservices.dam.configuration.crawler_batch_size          | regards.crawler.max.bulk.size         |
| group_docker_mservices.dam.configuration.jobs_pool_size              | regards.jobs.pool.size                |
| group_docker_mservices.dam.configuration.elastic_bulk_save_pool_size | regards.elasticsearch.threadpool.size |

:::info
For more details, check the REGARDS property description for rs-dam microservice  [here](../../../development/services/dam/configuration/dam-static-configuration.md)
:::
