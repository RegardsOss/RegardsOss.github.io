...
:::info
When this guide has been written, last version was 1.14.3. Check if there is an updated version available [here](https://github.com/orgs/RegardsOss/packages/container/package/rs-authentication)
:::
