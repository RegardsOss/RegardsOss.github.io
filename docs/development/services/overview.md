...
- [Access project](../services/access-project/overview.md) : **Access project** or **rs-access-project** microservice is
...
- [Admin project (rs-admin)](admin/overview.md) : **Admin project** or **rs-admin** manages project users and
  roles
