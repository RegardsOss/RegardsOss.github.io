...
| Search data objects in the specified dataset                      | /api/v1/rs-catalog/engines/opensearch/atasets/{urn}/dataobjects/search                           | GET  |
| Open Search description for all data objects in specified dataset | /api/v1/rs-catalog/engines/opensearch/atasets/{urn}/dataobjects/search/opensearchdescription.xml | GET  |
