        ...
        <div className="cards__wrapper">
            ...
            <CardItem
              ...
              text={
                <div>
                  ...
                  <p> Consequently, the system allows <b>high-performance ingestion</b> of data and metadata available from providers, either in
                  <b>standard or non-standard formats</b>.
                </p>
                </div>
              }
            />
            <CardItem
              ...
              text={
                <div>
                  ...
                  <p>REGARDS indexes metadata in a metacatalog structured by <b>hot defined data models</b>. and relying on the powerfull search engine
                   <a href="https://www.elastic.co/fr/products/elasticsearch" target="blank_"> ElasticSearch</a>.</p>
                </div>
              }
            />
            <CardItem
              ...
              text={
                <div>
                  ...
                  <p>Its metacatalog API provides a <a href="http://www.opensearch.org/Home" target="blank_"> standard OpenSearch API </a>
                   (with parameter, geo and time extensions) and responses in <a href="http://geojson.org/" target="blank_">GeoJson standard format</a>.</p>
                </div>
              }
            />
          </ul>
          <ul className="cards__items">
            ...
            <CardItem
              ...
              text={
                <div>
                  <p>REGARDS allows <b>to limit access to functionnalities</b> through the concept of <b>role</b>.
                  Default roles exist but you can create your own and define special user profile. <b>A user is always attached to a single role</b>.</p>
                  <p>Furthermore, REGARDS allows to limit metadata and data accesses through the concept of <b>group</b>.
                  A group define accesses to one or more dataset. To be able to access these datasets, <b>a user will have to be attached to one or more groups</b>.</p>
                </div>
              }
            />
          </ul>
          <ul className="cards__items">
            <CardItem
              ...
              text={
                <div>
                  <p>REGARDS is a cloud native system and more precisely a microservice architecture. The system core integrates <b>load balancing for batch jobs</b>
                   to enable hot-plugging of system resources.</p>
                </div>
              }
            />
            <CardItem
