...
- `criterion plugins`, that are used in the search form of search-results module ([more details here](criteria))

![](/images/frontend/plugins/search-form.png)
_A search form example, with several criteria plugins_

- `service plugins`, that adds functionalities to an entity or a selection of entities ([more detail here](service)).
...
- Other plugin properties are specific to the plugin type, see [criterion](criteria) or [service](service) plugin pages for more detail.
