    |Path|Type|Description|Constraints| |:--:|:--:|:---------:|:---------:|
        ...
        |content[].content.sipState| `String` | SIP State|Allowed values : NOT_SCHEDULED, NOT_SCHEDULED_INVALID, SCHEDULED, SCHEDULED_INTERRUPTED, GENERATION_ERROR, SUBMITTED|
