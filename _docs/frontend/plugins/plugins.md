...
All plugins configuration panels are automaticly generated by the administror interface using the plugin-info.json (conf part) to generate configurable fields, according with attributes and properties types.
