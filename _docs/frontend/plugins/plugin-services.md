...
A front-end service plugin is a javascript bundle used by [search results modules](/frontend/modules/search-results/) to add a graphical service onto a given entity or entities selection.
