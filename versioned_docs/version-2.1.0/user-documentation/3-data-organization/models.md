...
- soit importer un fichier XML qui importera directement un fragment et ses attributs. Lire [Create a model](../../development/appendices/03-create-model.md) pour écrire ce fichier.
